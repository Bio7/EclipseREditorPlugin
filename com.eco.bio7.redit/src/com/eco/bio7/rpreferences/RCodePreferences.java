...
public class RCodePreferences extends FieldEditorPreferencePage implements IWorkbenchPreferencePage, PropertyChangeListener {
	...
	public void createFieldEditors() {
		...
		addField(new BooleanFieldEditor("SHOW_HOVERPOPUP_STR", "Show Hover Object Popup (str())", getFieldEditorParent()));
		...
		addField(new BooleanFieldEditor("REDITOR_EDIT_INDENT", "Automatically indent", getFieldEditorParent()));
		addField(new BooleanFieldEditor("CLOSE_BRACES_LINEBREAK", "{Braces - with linebreak}", getFieldEditorParent()));
		addField(new SpacerFieldEditor(getFieldEditorParent()));
		addField(new LabelFieldEditor("Spell Checking:", getFieldEditorParent()));
		addField(new BooleanFieldEditor("CHECK_SPELLING_REDITOR", "Enable Spell Checking", getFieldEditorParent()));
	}
